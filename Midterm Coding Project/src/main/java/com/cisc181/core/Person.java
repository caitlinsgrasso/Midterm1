...
public abstract class Person implements java.io.Serializable {
	...
	public Date getDOB() throws PersonException {
		...
		// throw exception if DOB is more than 100 years older than current date
		if ((birthDate.get(Calendar.MONTH) == today.get(Calendar.MONTH))
				&& (birthDate.get(Calendar.DAY_OF_MONTH) == today.get(Calendar.DAY_OF_MONTH))
				&& (birthDate.get(Calendar.YEAR) == (today.get(Calendar.YEAR) + 100))) {
	...
	public String getPhone() throws PersonException {
		char a = phone_number.charAt(0);
		char b = phone_number.charAt(4);
		char c = phone_number.charAt(5);
		char d = phone_number.charAt(9);
		if (a!='(' || b!=')' || c!='-' || d!='-') {
